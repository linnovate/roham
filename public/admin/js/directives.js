angular.module('roham-admin.system').directive('ngEnter', function() {
...
angular.module('roham-admin.system').directive('ngEditable', function() {
    return {
...
angular.module('roham-admin.system').directive('ngEditableParagraph', function() {
    return {
        // can be in-lined or async loaded by xhr
        // or inlined as JS string (using template property)
...
angular.module('roham-admin.system').directive('ngEditableSelect', function() {
    return {
